...
public class EndPoints {
    ...
    public static final String CREATE_PRODUCT_BY_ID = "";
    public static final String UPDATE_PRODUCT_BY_ID = "/{productsID}";
    public static final String DELETE_PRODUCT_BY_ID = "/{productsID}";
